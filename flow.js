...
(function(){
  ...
  const Q = [
    {ax:"EI", s:"3人で初めて会う日。待ち合わせ場所に着いたら、1人は来ているけど、もう1人はまだ来ていない。", l:"自然と話しかけて場を盛り上げる", r:"来るまでスマホを見て待っている"},
    {ax:"EI", s:"グループLINEがしばらく沈黙している。", l:"話題を投げて動かしたくなる", r:"誰かが送るのを自然に待っている"},
    {ax:"EI", s:"3人で行くお店を決めるとき。", l:"「ここどう？」と候補を出している", r:"誰かの候補に「いいね」と乗っている"},
    {ax:"AS", s:"友達の友達と初めて会う飲み会が終わった。", l:"新しい人と話せて楽しかった、また会いたい", r:"既存の友達とゆっくり話せなかったのが残念"},
    {ax:"AS", s:"自分のLINEの友達リストを思い浮かべたとき。", l:"繋がっていないグループが複数バラバラにある", r:"仲のいいグループが決まっていてそこに集中している"},
    {ax:"AS", s:"今の3人グループに、新しい4人目が加わることになった。", l:"新しい化学反応が起きそうで楽しみ", r:"今の3人の空気感が変わらないか少し心配"},
    {ax:"FL", s:"3人の中の1人が、最近元気がないと感じた。", l:"「大丈夫？」と声をかけて話を聞こうとする", r:"気分転換になりそうな場所や遊びを提案する"},
    {ax:"FL", s:"グループで意見が割れて、なかなか決まらない。", l:"それぞれの気持ちを確認しながら落としどころを探す", r:"「じゃあこれにしよう」と決断して前に進める"},
    {ax:"FL", s:"3人で会った翌日、一番残っているのは。", l:"あの瞬間みんなが笑っていた、あの空気感", r:"次回どこに行くか、何をするかの具体的なイメージ"},
    {ax:"CV", s:"仲のいい友達と、半年ぶりに会う。", l:"久しぶりでもすぐ元通りになれる自信がある", r:"少し間が空くと関係がリセットされた感覚になる"},
    {ax:"CV", s:"引っ越しや転職など、環境が大きく変わったとき。", l:"前の関係を大切に続けようとする", r:"新しい環境で新しい人間関係を作る方にエネルギーが向く"},
    {ax:"CV", s:"3年付き合いのある友達グループと、最近できた新しいグループ。", l:"歴史があって何でも話せる3年来のグループが居心地いい", r:"新鮮でまだ知らないことが多い新しいグループが居心地いい"},
  ];
