...
(function(){
  ...
  function wordmark(scale, light){
    ...
    return `<span style="display:inline-flex;align-items:center;gap:${11*s}px">
      ...
      <span style="font-family:'Zen Maru Gothic',sans-serif;font-weight:900;font-size:${23*s}px;color:${c};letter-spacing:.04em">ChilIn</span>
    </span>`;
  }
  ...
  window.ChilInShare = { build, SIZES, DIAG_URL, HOST, wrapJP };
})();
